...
const Header = () => {
    ...
    return (
        <div className='border-b shadow-sm bg-white sticky top-0 z-10'>
            <div className='flex justify-between items-center h-16 px-2 mx-auto'>
                <div className="flex">
                ...
                <div className="hidden w-72 sm:flex relative mx-4">
                    ...
                    <input type="text" name="" id="" placeholder='Search ' className="h-9 w-full rounded-md bg-[#efefef] pl-8 outline-0" />
                </div>
                <div className="flex space-x-5">
                    ...
                    <div className="flex">
                        ...
                        <button className='cursor-pointer text-[#0095f6] font-semibold whitespace-nowrap'>Sign out</button>
                    </div>
